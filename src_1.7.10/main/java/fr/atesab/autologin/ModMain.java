 ...
 * @since 1.0
 */
@Mod(name = ModMain.MOD_NAME, version = ModMain.MOD_VERSION, modid = ModMain.MOD_ID, canBeDeactivated = true, guiFactory = ModMain.MOD_FACTORY)
public class ModMain {
	...
	private static final AutoLoginSkin SKIN_AL = new AutoLoginSkin() {
		...
		public void drawBackground(GuiOption<?> screenOption) {
			...
			int c = screenOption.getGui().mc.theWorld == null ? 0xff444444 : 0x44000000;
	...
	static {
		...
		skins.put("psy", new AutoLoginSkin() {
			...
			public void drawBackground(GuiOption<?> screenOption) {
				...
				if (screenOption.getGui().mc.theWorld != null)
